...
# por último podemos convinar varias condiciones en cascada con elif y conbinarlo con else.
pet = input("cual es tu mascota favorita?: ")
if pet == 'perro':
    print("amo a los perros.")
elif pet == 'gato':
...
# computacional y con el elif una vez que se cumpla una condición ya no evalua las restantes.