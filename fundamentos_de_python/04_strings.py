...
# conoce como concatenación y se realizá con el operador de suma ("+").
...
# donde ciertas partes del texto son dinamicas.
plantilla = "Hola, mi nombre es {} y mi apellido es {}.".format(name, last_name)
print(plantilla)
# otra forma de hacer lo mismo es con la sintaxis f""
# es casi igual solo que el nombre de las varibales va dentro de las llaves y no como
